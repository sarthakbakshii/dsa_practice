...
You are given two numbers nand k. The number p iscreated by 
...
Otherwise, thesuperdigit of p is equal to 
thesuperdigit of the sum of the digits of p.
Read the Sample input explanation for better understanding.
====================================================================
Input

The first line contains two space-separated integers,n-a string 
representation of an integerand k-an integer, 
...
const break_n_sum = str =>{
    ...
    sum = sum.toString();
    // console.log(sum);
    return break_n_sum(sum);
}
// break_n_sum(123)
console.log( break_n_sum("123123123")  )
